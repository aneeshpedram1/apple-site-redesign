    ...
    <main className="mx-auto max-w-5xl pb-24">
        ...
        {items.length > 0 && (
            <div className="mx-5 md:mx-8">
                ...
                <div className="my-12 mt-16 ml-auto max-w-3xl">
                    <div className="divide-y divide-gray-300">
                        ...
                        <div className="flex justify-between pt-4 text-xl font-semibold">
                            <h4>Total</h4>
                            <h4>
                                <Currency quantity={basketTotal} currency="USD" ></Currency>
                            </h4>
                        </div>
                    </div>
                    <div className="my-14 space-y-4 ">
                        ...
                        <div className="flex flex-col gap-4 md:flex-row">
                            ...
                            bg-gray-200 p-8 py-12 text-center ">
                                ...
                                <Button title="Checkout with Apple Card Monthly Installments"></Button>
                                <p className="mt-2 max-w-[240px] text[13px]">
                                    $0.00 due today, which includes applicable full-price 
                                    items, down payments, shipping and taxes.
                                </p>
                            </div>
                            <div className="flex flex-1 flex-col items-center space-y-8 rounded-xl bg-gray-200 
